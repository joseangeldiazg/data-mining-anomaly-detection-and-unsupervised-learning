...
\begin{figure}[h]
\centering
\includegraphics[width=9cm]{./Anomalias/imagenes/supervisado.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=9cm]{./Anomalias/imagenes/semisupervisado.png}
...
Los métodos vistos anteriormente, no dejan de ser en su esencia métodos de clasificación, en el que clasificamos anomalías en base a conocimiento previo. Es en el enfoque no supervisado, donde realmente encontramos la dificultad y el objetivo final de la detección de anomalías, ante un problema donde no sabemos que ejemplo corresponde a una anomalía y que no (figura \ref{nosupervisado}). En este enfoque tendremos métodos gráficos, métodos basados en vecinos cercanos y métodos basados en clustering. 
...
\begin{figure}[h]
\centering
\includegraphics[width=9cm]{./Anomalias/imagenes/nosupervisado.png}
