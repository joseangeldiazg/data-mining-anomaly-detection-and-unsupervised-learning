...
Para este análisis nos querdaremos con las variables numéricas, eliminando todas las demás de nuestros datos. Dado el caracter de las funciones que usaremos, ademas tendremos que definir un indice de columna y un nombre para los gráficos. 
