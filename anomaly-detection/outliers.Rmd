...
Nuevamente se hace muy complicado el estudio de los outliers, ya que los datos son muchos y solo se han tenido en cuenta dos variables para que su combinación de como resultado un outlier. Trataremos de centrarnos en los índices de outliers 2 varite que hemos obtenido antes para analizar que puede estar pasando, antes trataremos de mostrar en rojos estos outliers respecto a las correlaciones de las variables para intentar de encontrar algun patron. 
