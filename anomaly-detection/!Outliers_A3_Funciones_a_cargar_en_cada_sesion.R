...
# de "datos" es o no un outlier (según el m?todo aplicado) 
# y el t?tulo a aparecer en el gráfico
...
MiBoxPlot_IQR_Univariate_Outliers = function (datos, indice.de.columna, coef = 1.5){
  # Importante: Para que aes busque los par?metros en el ámbito local, debe incluirse  environment = environment()
